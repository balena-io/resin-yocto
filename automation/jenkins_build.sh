...
JENKINS_DEPLOY_DIR=$JENKINS_PERSISTENT_WORKDIR/$MACHINE/deploy
...
BUILD_DEPLOY_DIR=$JENKINS_DEPLOY_DIR/$sourceBranch/$BUILD_NAME
...
ln -snf $BUILD_NAME $JENKINS_DEPLOY_DIR/$sourceBranch/$sourceBranch-latest
